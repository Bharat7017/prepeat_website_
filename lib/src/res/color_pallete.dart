...
class ColorPallete {
  ...
  static const Color orange2 = Color(0xFFE8750B);
  static const Color lightorange = Color(0xE8FECCAB);
  static const Color teal = Color(0xFF06666D);
  static const Color lightteal = Color(0xFF98E2EF);
  static const Color red = Color(0xFFAB0000);
  static const Color lightred = Color(0xFFFFCACA);

...
class DesktopTiffinServiceBanner extends StatelessWidget {
  const DesktopTiffinServiceBanner({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        image: AssetImage(ImageAssets.desktoptiffinservicebanner),
        fit: BoxFit.fitWidth,
      )),
      child: Row(
